...
export function OrbitingCirclesDemo() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-background">
      ...
      <OrbitingCircles
        className="size-[50px] border-none bg-transparent text-white"
        radius={190}
        duration={20}
        delay={39.9}
        reverse
...
const Icons = {
  ...
  nextJs: () => (
    <Image src={'/next.svg'} alt="react" width={120} height={100} className="invert" />
  ),
  react: () => (
    <Image src={'/react.svg'} alt="react" width={100} height={100} />
  ),
  node: () => (
    <Image src={'/node.svg'} alt="react" width={100} height={100} />
  ),
  express: () => (
    <Image src={'/expressjs.svg'} alt="react" width={100} height={100} className="invert" />
  ),
  mongodb: () => (
    <Image src={'/mongo.svg'} alt="react" width={100} height={100} />
  )
};
